    ...
    <div class="row">
        ...
        <div class="col-10">
            <div class="filtros mb-3">
                <div><?php echo e($fabricantes->links()); ?></div>
                ...
                <thead>
                    ...
                    <?php $__currentLoopData = $fabricantes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fabricante): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($fabricante->email); ?></td>
                            <td><?php echo e($fabricante->cnpj); ?></td>
                            <td><?php echo e($fabricante->estado); ?></td>
                            <td><?php echo e($fabricante->municipio); ?></td>
                            <td><?php echo e($fabricante->telefone); ?></td>
                            <td><?php echo e($fabricante->bairro); ?></td>
                            <td><?php echo e($fabricante->rua); ?></td>
                            <td><?php echo e($fabricante->numero); ?></td>
                            <td>
                                <button class="btn btn-darkleve" data-id="<?php echo e($fabricante->id); ?>" onclick="editarFabricante(this)">Editar</button>
                                <button class="btn btn-danger" data-id="<?php echo e($fabricante->id); ?>" onclick="excluirFabricante(this)">Excluir</button>
                            </td>
                        </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Estoque\resources\views/fabricantes.blade.php ENDPATH**/ ?>